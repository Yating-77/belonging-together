    ...
    <div>
      <div
        ...
        :class="{
          ...
          'forgot-password-active': isForgotPasswordActive
        }"
        id="container"
      >
        <!-- Sign Up -->
        ...
        <div class="form-container sign-in-container">
          <form @submit.prevent>
            ...
            <input type="email" placeholder="Email" />
            <input type="password" placeholder="Password" />
            <a href="#" @click.prevent="isForgotPasswordActive = true">Forgot your password?</a>
        ...
        <div class="overlay-container">
          <div class="overlay">
            <div class="overlay-panel overlay-left">
              ...
              <button class="ghost" @click="isRightPanelActive = false">Sign In</button>
            </div>
            <div class="overlay-panel overlay-right">
              <h1>Hello, Friend!</h1>
              <p>Enter your personal details and start journey with us</p>
              <button class="ghost" @click="isRightPanelActive = true">Sign Up</button>
            </div>
          </div>
        </div>
      </div>
