  ...
  <nav class="my-navbar" data-aos="fade-down">
    ...
    <div class="mobile-menu" :class="{ 'active': mobileMenuOpen }">
      <ul class="mobile-links">
        ...
        <li><router-link to="/detectpage" @click="closeMobileMenu">Detect</router-link></li>
        <li><router-link to="/sensoryVenue" @click="closeMobileMenu">Sensory Venue</router-link></li>
      </ul>
    </div>
  </nav>
</template>
