  ...
  <div class="game-container">
    ...
    <div class="right-panel">
      ...
      <div class="task-hint">
        ...
        <div class="hint-text">
          <span v-if="currentStep.id === 'get_toothbrush'"><strong><b>Click</b> on the toothbrush and toothpaste</strong> in the cup to start</span>
          <span v-if="currentStep.id === 'apply_toothpaste'"><strong>Drag "<em>toothpaste</em>"</strong> under available items to the toothbrush</span>
          <span v-if="currentStep.id === 'open_tap'"><strong>Drag "<em>Hand</em>"</strong> under available items to the tap to turn on the water</span>
          <span v-if="currentStep.id === 'wet_toothbrush'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the water</span>
          <span v-if="currentStep.id === 'brush_left_top'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the upper left teeth</span>
          <span v-if="currentStep.id === 'brush_left_bottom'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the lower left teeth</span>
          <span v-if="currentStep.id === 'brush_right_top'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the upper right teeth</span>
          <span v-if="currentStep.id === 'brush_right_bottom'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the lower right teeth</span>
          <span v-if="currentStep.id === 'brush_front_top'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the upper front teeth</span>
          <span v-if="currentStep.id === 'brush_front_bottom'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the lower front teeth</span>
          <span v-if="currentStep.id === 'fill_cup'"><strong>Drag "<em>cup</em>"</strong> under available items to the water to fill it</span>
          <span v-if="currentStep.id === 'rinse_mouth' && currentStepIndex < 13"><strong>Drag "<em>cup</em>"</strong> under available items to your mouth to rinse</span>
          <span v-if="currentStep.id === 'spit_water'"><strong>Drag "<em>mouth</em>"</strong> under available items to the sink to spit the water</span>
          <span v-if="currentStep.id === 'rinse_toothbrush'"><strong>Drag "<em>toothbrush</em>"</strong> under available items to the water to rinse</span>
          <span v-if="currentStep.id === 'rinse_mouth' && currentStepIndex > 13"><strong>Drag "<em>mouth</em>"</strong> under available items to the water to rinse</span>
          <span v-if="currentStep.id === 'wipe_mouth'"><strong>Drag "<em>towel</em>"</strong> under available items to your mouth to wipe</span>
        </div>
      </div>
...
function shouldShowItem(itemId) {
  ...
  if (currentStepId === 'get_toothbrush' && currentStep.value.isClickable) {
    return false;
  }
...
function handleDragOverToothbrush(event) {
  if (currentStep.value.dropTarget === 'toothbrush_area') {
...
function handleDragOverMouth(event) {
  if (currentStep.value.dropTarget === 'mouth') {
...
function handleDropOnTarget(targetId) {
  ...
  if (currentStep.value.id === 'get_toothbrush' && currentStep.value.isClickable) {
    feedbackMessage.value = 'Please click on the toothbrush to start.';
...
function getItemName(itemId) {
  switch(itemId) {
    ...
    case 'toothpaste': 
      return 'Toothpaste';
    case 'toothbrush_paste': 
      return 'Toothbrush with paste';
    case 'toothbrush_foaming': 
      return 'Foaming toothbrush';
    case 'cup': 
      return 'Cup';
    case 'cup_water': 
...
function getToothbrushAreaStyle() {
  ...
  if (currentStep.value.id === 'get_toothbrush') {
    // Step 1: Click toothbrush area - make it more obvious with additional styling
    return {
      position: 'absolute',
      bottom: '48%',
      left: '52%',
      ...
      height: '30%',
      zIndex: 2,
      border: currentStep.value.isClickable ? '3px solid rgba(62, 92, 43, 0.7)' : '2px dashed transparent',
      backgroundColor: currentStep.value.isClickable ? 'rgba(62, 92, 43, 0.1)' : 'transparent',
      animation: currentStep.value.isClickable ? 'pulse-zone 2s infinite' : 'none',
      cursor: currentStep.value.isClickable ? 'pointer' : 'default'
    };
...
function handleDragOverFrontTopTeeth(event) {
  if (currentStep.value.dropTarget === 'front_top_teeth') {
...
function handleDragOverFrontBottomTeeth(event) {
  if (currentStep.value.dropTarget === 'front_bottom_teeth') {
...
function handleDragOverLeftTopTeeth(event) {
  if (currentStep.value.dropTarget === 'left_top_teeth') {
...
function handleDragOverLeftBottomTeeth(event) {
  if (currentStep.value.dropTarget === 'left_bottom_teeth') {
...
function handleDragOverRightTopTeeth(event) {
  if (currentStep.value.dropTarget === 'right_top_teeth') {
...
function handleDragOverRightBottomTeeth(event) {
  if (currentStep.value.dropTarget === 'right_bottom_teeth') {
...
function handleDragOverTap(event) {
  if (currentStep.value.dropTarget === 'tap_area') {
...
function handleDragOverWater(event) {
  if (currentStep.value.dropTarget === 'water_area') {
...
function handleDragOverSink(event) {
  if (currentStep.value.dropTarget === 'sink_area') {
